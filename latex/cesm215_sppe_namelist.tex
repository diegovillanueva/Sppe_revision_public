...
At the CLUBB--MG coupling level, \texttt{cld\_macmic\_num\_steps = 3} divides the 1800\,s atmospheric time step into three coupled calls of 600\,s each; within each call, \texttt{micro\_mg\_num\_steps = 8} yields an MG microphysics time step of 75\,s.
